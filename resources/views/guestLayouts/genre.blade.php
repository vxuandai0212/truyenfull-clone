...
@section('title')
<title>Truyện {{$genre->gender_name}}</title>
@endsection
...
<div class="container breadcrumb-container">
    <ol class="breadcrumb">
        ...
        <li class="active" itemscope itemtype="http://data-vocabulary.org/Breadcrumb">
            <h1><a href="{{route('genre', ['genre_slug' => $genre->slug])}}" title="{{$genre->gender_name}}" itemprop="url"><span itemprop="title">{{$genre->gender_name}}</span></a></h1></li>
    </ol>
</div>
</div>
@endsection
            ...
            <div class="col-xs-12 col-sm-12 col-md-9 col-truyen-main">
                <div class="list list-truyen col-xs-12">
                    <div class="title-list">
                        <h2>Truyện {{$genre->gender_name}}</h2>
                        <div class="filter">
                            <a href="{{route('genre', ['genre_slug' => $genre->slug])}}"></a>
                        </div>
                    </div>
                    ...
                    <div class="row" itemscope itemtype="http://schema.org/Book">
                        ...
                        <div class="col-xs-7">
                            <div><span class="glyphicon glyphicon-book"></span>
                                <h3 class="truyen-title" itemprop="name"><a href="{{route('book', ['book_slug' => $book->slug])}}" title="{{$book->book_name}}" itemprop="url">{{$book->book_name}}</a></h3><span class="label-title label-new"></span><span class="label-title label-full"></span><span class="author" itemprop="author"><span class="glyphicon glyphicon-pencil"></span>@foreach($book->authors as $author){{$author->author_name}}@endforeach</span>
                            </div>
                        </div> 
